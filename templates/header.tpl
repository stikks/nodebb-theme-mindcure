...
<body class="{bodyClass} skin-{config.bootswatchSkin}">
	...
	<main id="panel" class="slideout-panel">
		<nav class="navbar navbar-default navbar-fixed-top header"style="box-shadow: 0 1px 5px 0px rgba(0, 0, 0, 0.2) !important; background: white !important; border-bottom: 1px solid #6969699e !important;"  id="header-menu" component="navbar">
			<div class="container">
