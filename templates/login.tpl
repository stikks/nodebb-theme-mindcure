			...
			<form class="form-horizontal" role="form" method="post" id="login-form">
				...
				<div class="form-group">
					<div class="col-lg-offset-2 col-lg-10">
						...
						<span>[[login:dont_have_account]] <a href="https://mindcureglobal.com/accounts/register">[[register:register]]</a></span>
						<!-- ENDIF allowRegistration -->
						&nbsp; <a id="reset-link" href="https://mindcureglobal.com/password_reset/">[[login:forgot_password]]</a>
					</div>
				</div>
			</form>
