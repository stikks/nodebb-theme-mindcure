...
<div class="unread">
	<div class="btn-toolbar">
		...
		<div component="category/dropdown" id="fab_user" class="btn-group pull-right category-dropdown-container">
			<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
	...
	<div class="category">
		<div id="category-no-topics" class="alert alert-warning <!-- IF topics.length -->hidden<!-- ENDIF topics.length -->" style="padding: 10px">[[unread:no_unread_topics]]</div>
